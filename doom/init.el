...
(doom! :input
       ...
       (java +meghananda +eclim +lsp)       ; the poster child for carpal tunnel syndrome
       ...
       (ruby +lsp +rvm +ebenv +rails +chruby)     ; 1.step {|i| p "Ruby is #{i.even? ? 'love' : 'life'}"}
       (rust +lsp)       ; Fe2O3.unwrap().unwrap().unwrap().unwrap()
       (scala +lsp)             ; java, but good
       (scheme +Chez +chibi +chicken +gambit +gauche +guile +kawa +mit +racket)   ; a fully conniving family of lisps
